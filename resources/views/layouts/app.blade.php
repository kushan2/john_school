...
<nav class="mobile-nav top">
    ...
    <a href="{{ route('pages.media') }}" class="{{ request()->routeIs('pages.media') ? 'active' : '' }}">
    ...
    <a href="#" onclick="if(window.openAssistant){window.openAssistant();}return false;">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
        Assistant
    </a>
</nav>
...
<nav class="mobile-nav bottom">
    ...
    <a href="{{ route('pages.classifieds') }}" class="{{ request()->routeIs('pages.classifieds') ? 'active' : '' }}">
