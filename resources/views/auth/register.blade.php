...
<head>
    ...
    <title>Suny Chat | Registration</title>
...
.form-group { margin-bottom: 16px; }
    ...
    input:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(79,142,247,.12); }
        ...
        .check-label { display: flex; align-items: center; gap: 8px; font-size: 13px; color: var(--text-sub); cursor: pointer; }
...
<div class="wrap">
    <div class="logo">
        ...
        <div class="logo-title">SUNY CHAT REGISTRATION</div>
        <!--<div class="logo-sub">Secure Access Only</div>-->
    </div>

    <div class="card">
        <div class="card-title">REGISTER below to create your own server</a> 
        </div>
        ...
        <form method="POST" action="{{ route('user.register') }}">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Your name" class="{{ $errors->has('name') ? 'input-error' : '' }}" required autofocus>
            </div>
            <div class="form-group">
                <label>Email</label>
            ...
            <div class="row-between" style="color: black;">
